...
type IconName = "archive" | "arrow" | "back" | "board" | "calendar" | "cart" | "category" | "chart" | "chart-line" | "chart-pie" | "chart-trend" | "check" | "checklist" | "chevron" | "clock" | "close" | "clipboard" | "cube" | "database" | "doc" | "external-link" | "fail" | "feed" | "filter" | "flame" | "grid" | "home" | "info" | "layers" | "list-check" | "message-check" | "money" | "note" | "panel" | "percent" | "pkg" | "plus" | "refresh" | "rocket" | "search" | "settings" | "shield" | "star" | "sparkle" | "sync" | "tag" | "target" | "trash" | "upload" | "user-star" | "users" | "video" | "waiting" | "warehouse" | "world" | "warn";
type IconProps = {
    name: IconName;
    size?: number;
    strokeWidth?: number;
 ...
 */
declare function DataTableColumnHeader({ label, sortable, sortDirection, onSort, filterValue, onFilterChange, filterPlaceholder, }: DataTableColumnHeaderProps): react.JSX.Element;
