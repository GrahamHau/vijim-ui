...
import { ReactNode, CSSProperties, ChangeEventHandler, KeyboardEvent, ReactElement, MouseEventHandler } from 'react';
...
declare function Icon({ name, size, strokeWidth, className, style, color, }: IconProps): react.JSX.Element;
